  ...
  return (
    ...
    >
      ...
      <div className="flex items-center space-x-6">
        ...
        <button className={`text-custom-blue text-lg font-semibold ${scrolled ? 'bg-white hover:bg-white' : 'bg-white hover:bg-custom-blue'} px-8 py-2 rounded-full font-Montserrat-SemiBold`} onClick={gotoSignUp}>Sign Up</button>
      </div>
    </div>
  );
};
